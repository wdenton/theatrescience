...
\begin{description}[align=right,labelwidth=2cm]
  ...
  \begin{description}[align=right,labelwidth=2cm]
    ...
    \item [S3] just speaks from the score % limited movement; stays in the podium zone
  \end{description}
...
\technicalbox{}{A dashed box has technical cues, which are also in italics to set them apart. Only Q and R will act on them.}
...
Hard-to-pronounce words also have a phonetic pronunciation with capital letters indicating emphasis:
...
During the performance, don't worry if there is some noise or things happen.  Just pay attention and listen.
...
To play a note, do this:  pick any key on the piano, hit it hard, and keep pressing the key down until you can no longer hear any sound from it, even if performers start talking.  Wait a few more seconds to be sure, then lift up your finger.
...
\technicalbox{q}{LX: House lights to Look 1 (full).  Work lights off.  Lighting board on.  GM\(\uparrow\)10. Single-scene mode.  Flash off.  A\(\downarrow\)0.  B\(\uparrow\)0.  (2,5)\(\uparrow\)8. (3,4)\(\uparrow\)4.  (20,21)\(\uparrow\)8.  }
...
\technicalbox{q}{SX:  Prepare the microphone for the announcement.  Get a handheld microphone from the podium drawer and check that the battery is good enough.  Check which channel it's on, and move that input level to the mark.  Put it on mute.  Turn the mike off.}

\technicalbox{q}{SX:  Prepare the thirty-minute introductory countdown and the introductory audio so they are ready to play one after the other without manual intervention.}

\technicalbox{q}{SX:  Confirm the piano is ready to be played.  Put it at full stick.}

\technicalbox{q}{SX:  At 1928, lower the headphones down to R, who will place them on the plinth.  This is part of the show, but need not be explained.}
...
\technicalbox{q}{LX:  At 1950, turn off the art lights in the Great Hall.  There is a box in the cupboard under the light control inside the entrance.  Turn off switches 5 and 6.  The small lights facing the art on the walls will go off.}

\technicalbox{q}{SX:  On the way back upstairs, bring the gong and the mallet.  Place them near the sound board.}

\technicalbox{q}{SX:  At 1959, when the one-minute warning has played, lower the house lights to Look 4 (house lights and buffet lights to 65\%).}
...
\speak{p}{This show is about a concept from library and information science.  The concept is:  \textit{Authority is constructed and contextual.} }
...
\speak{p}{An example.  An artist.  A musician.  \direction{Pause 1}  John Cage.}
...
\speak{s1}{He was enormously talented and always curious.  He was noted for his kindness.  Younger composers appreciated the interest and generosity he showed even when they were doing work very different from his.}
...
\speak{s3}{Cage spent most of his life with \pronounce{Merce}{MURSE} Cunningham, a dancer and choreographer.  Cage composed many works for the Merce Cunningham Dance Company, and together they toured the world.}
...
\speak{p}{The quote is \direction{Pause 1}: ``There is no such thing as silence.''}

\directionbox{st}{Give an exaggerated shrug and knowing wink to an audience member of your choice.}

\directionbox{s1}{Walk the blue line to the pink line, stop on the X.}

\directionbox{s2}{Walk the pink line to the blue line, stop on the X.}
...
\speak{s1}{John Cage made music for seventy years.  He began by composing for percussion.  In the late 1930s he invented the prepared piano, by putting bolts and wires and others objects on or between the actual strings.  This turns the piano into a one-person percussion ensemble.}
...
\speak{s3}{In the late 1950s he began to move into a new phase where he wanted to build \textit{indeterminacy}.  He said, ``More essential than composing by means of chance operations, it seems to me now, is composing in such a way that what one does is indeterminate of its performance.   In such a case one can just work directly, for nothing one does gives rise to anything preconceived.''}

\speak{p}{For example, he might put marks on piece of paper and lines on a clear transparent sheet, and decide different types of sound.  Then a performer would put the transparent sheet on top of the paper, pointing whichever way they want, and decide which lines went with which sounds.}

\speak{s1}{He sometimes made music that lasted for hours.  There is a short piece by French composer Erik Satie called \textit{Vexations} that takes about one minute to play, but Satie included cryptic instructions that mention playing it 840 times.  Cage took him at his word and arranged a performance where several pianists worked in stages to play it 840 times, which took about sixteen hours.}

\speak{s2}{Cage's work for organ, \pronounce{\textit{Organ\textsuperscript{2} ASLSP}}{Organ 2 A--S--L--S--P}, is currently being performed at a church in Germany.  The instructions say it should be performed ``as slow as possible.''  This performance started in 2000 and will take 639 years to finish.   It begins with a rest, so for the first seventeen months no note was played.}

\speak{s3}{Cage also wrote and spoke about music.  He published many articles, several books and hundreds of poems.  His collected writings, particularly \textit{Silence} from 1961, are still frequently quoted.  He was an excellent interview subject, and talked openly about his methods and philosophy.  All in all there are many volumes filled with his words.}

\speak{p}{You may be unfamiliar with Cage's music.  It's rare to hear it without making a special effort, though if you have access to a streaming music service you will find a lot there, with more added every year.  And remember \textit{Grove Music Online}: ``He had a greater impact on music in the 20th century than any other American composer.''  \direction{Pause 1} Next: mushrooms.}
...
\directionbox{s1}{Cross to the plinth and stand in front of the chair.  To prepare, read the instructions below but do not follow them.  When you know what is going to happen, go through them again, but this time follow them. \\
  \\
...
\directionbox{performers}{While the Mushroom Verbatim is happening, look at the speaker.}

\tstechnical{Q: SX: At the thumbs up, play ``Indeterminacy 66'' audio file over headphones.}
...
\tstechnical{Q: SX: At the thumbs up, play ``Indeterminacy 60'' audio file over headphones.}

\directionbox{s2}{When the story is over, put the headphones back on the plinth, pick up your binder, and return to where you were standing, then cross to the green tape and go towards the entrance curtains.  Turn onto the blue line and go to the blue square.  Face the piano.}
...
\speak{t2}{``This is probably one of the stupidest things I have ever heard, not heard?  My music history professor has never been angrier than when she was teaching us about John Cage and this stupid song.''} % Captian Bigums
...
\speak{p}{Cage's authority on mushrooms seems clear.  Whether or not he is an authority on music is entirely different.  \textit{Is} he an authority for you? Do you look to him for lessons about how to find and create art and life?  Maybe he \textit{isn't} an authority for you: nothing of his work is an influence, and he and his followers are completely removed from your practice.}

\speak{s1}{In which case, you will have your own different authorities.  Either way, the authority is constructed.  Different communities recognize different types of authority.  Here in Toronto, Cage is an authority at Soundstreams and the Music Gallery.  At Opera Atelier and Tafelmusik, he is not.}
...
\directionbox{t2}{Sit in your chair.}

\directionbox{t3}{Sit in your chair.}
...
\directionbox{p}{To prepare, first read the instructions below but do not follow them.  When you know what is going to happen, go through them again, but this time follow them.\\
  ...
  \\
  Stand facing the stage.  Place your score face up on the chair.  Put on the headphones.  When the others have put their scores on the floor, they are ready.  When you are ready, make a ``thumbs up'' with each hand.  You will hear two bongs, then Ashley Williamson telling you what to do to conduct.  Follow the instructions.}

\technicalbox{q}{SX: At the thumbs up, play audio file 433-instructions.mp3.}
...
\speak{p}{What about this show?  Who's the authority here?}

\speak{s1}{I'm just reading these words.  I didn't write them.  Why should you believe someone who's reading things aloud from a binder they received an hour ago?}

\speak{s2}{Williamson and Denton are presenting themselves as authorities.  Are they?  Ashley Williamson has a PhD in theatre studies.  William Denton is a librarian at York University.  They have some credentials, at least.}

\speak{s3}{This show combines their expertise:  it uses theatrical methods to investigate a concept from library science.  They cited their work.  They gave a bibliography.  The core concept comes from a reputable source.  Their hypothesis seems valid.}
...
\speak{p}{You heard the concept.  You heard the example.}
...
\speak{p}{Who's an authority?  When?  Where?  Why?  Are \textit{they}?  Are \textit{you}?}
...
\directionbox{performers}{The show is now over.  As people applaud, follow the next instructions to take your two bows.}

\newpageforperformers{}

\subsection{Curtain call}

\directionbox{ps}{Find your way to the plinth, where you will stand facing each other.}
...
\technicalbox{q}{LX:  In the Great Hall, turn on the art lights (switches 5 and 6).}
...
\textbf{``no such thing as silence''} Cage 51.
...
\textbf{``more essential than''} Cage (2003) 69;
\textbf{ASLSP} BBC;
...
The photograph of Donald Gillies is © 2019 by William Blakeney and provided courtesy of the photographer.  The photograph of John Cage is CC BY and from WikiArt.org.  The photograph of the \textit{Entoloma sinuatum} (not \textit{grayanum}, which are mentioned in the verbatim) is CC BY-SA by Archenzo.  The last two can be found in the relevant Wikipedia entries.
...
Printing of the audience scores is funded by a research grant from York University Libraries.

Thanks to everyone who helped along the way:  Lisa Aikman, Carol Anderson, Ramona Baillie, William Blakeney, Sophie Bury, Sarah Coysh, Donald Gillies, Thomas Gough, Kris Joseph, Kathy Lennox, Damon Lum, John Rammell, Patti Ryan, Dany Savard, Betty Trott, Josh Welsh, Brenda Williamson.
