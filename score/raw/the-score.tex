...
\directionbox{primary}{Follow the yellow line.  Stop on the square.}

\directionbox{secondaryone}{Follow the blue line on the right and stop on the X.}

\directionbox{secondarytwo}{Follow the green line on the left and stop on the X, then face P.}

\directionbox{secondarythr}{Follow the pink tape and stop on the chevrons, then face P.}

\directionbox{tertiaryone}{Follow the orange line until you come to your marked position.  Stand there.}

\directionbox{tertiarytwo}{Follow the orange line until you come to your marked position.  Stand there.}

\directionbox{tertiarythr}{Follow the orange line until you come to your marked position.  Sit there.}

\playanote{}

\directionbox{primary}{When you can no longer hear the note, wait one more second.  Slowly raise your arms over your head, then slowly lower them back to your sides.}
...
\technicalbox{r}{SLIDE: ``Information literacy is the set of integrated abilities \ldots''}

\directionbox{performers}{Note that some people move while P speaks.}

\directionbox{secondaryone}{Follow the blue line and stop on the blue triangle.}

\directionbox{secondarytwo}{Follow the green line and stop on the green triangle.}

\directionbox{secondarythr}{Follow the pink line to the blue line, then stop on the star.}
...
\primary{To help us, we're going to use an example.  An artist.  A musician.  \direction{Pause 1}  John Cage.}
...
\primary{\textit{Grove Music Online} is the largest and most respected reference source for music.  Here is what it says.}
...
\secondarytwo{He appeared in a surprising number of television game shows.  He was a Zen Buddhist.  He laughed a lot.  He organized the first Happenings.  He collaborated with Robert \pronounce{Rauschenberg}{ROWSH-en-burg}, Yoko Ono, and many, many others.  He was a mushroom expert: a \pronounce{mycologist}{my-COLL-o-jist}.}

\directionbox{secondarytwo}{Face the centre.}

\secondarythr{Cage was married to a woman artist for a decade, but spent most of his life with \pronounce{Merce}{MURSE} Cunningham, a dancer and choreographer.  Cage composed many works for Merce's dance company, and together they toured the world.}
...
\primary{It has three movements.  Each is the word \pronounce{``Tacet''}{TASS-it}.  This tells the musician not to play.  It was first performed by pianist David Tudor in 1952, in a concert space in the woods that was open to the outside.  He came on stage and sat at the piano.}
...
\tertiaryone{\direction{Pause 1} Authority.}

\tertiarytwo{Constructed.}

\tertiarythr{Contextual.}

\primary{\direction{Pause 1} This is the concept in question.  This is the \textit{frame} we are going to try to understand.  Let's look at the definition.}

\directionbox{performers}{Turn to look at the screen.}

\technicalbox{r}{SLIDE: ``Information resources reflect'' paragraph.}

\primary{Please read me that big block of text on the screen.}
...
\primary{There are two last little things about this frame.  It comes with some \textit{knowledge practices}.  Such as:}
...
\directionbox{primary}{Follow the blue line to the podium, then stand behind it, facing the centre.}
...
\directionbox{secondaryone}{Follow the pink line to the X.}

\directionbox{secondarytwo}{Follow the green line towards the stage.  Stop on the X.}

\directionbox{secondarythr}{Follow the pink line towards the entrance curtains, then cross to the yellow square.  Face the centre.}

\primary{Follow the blue line towards the entrance curtains.  Stop on the blue chevrons.}
...
\primary{John Cage became interested in mushrooms in 1954, when he was staying at a farmhouse.  He said:}
...
\primary{Asked if he had any favourite mushrooms, he said:}
...
\directionbox{secondaryone}{Walk straight to the the orange X in the centre.}

\directionbox{secondarytwo}{Walk straight to the orange square in the centre.}

\directionbox{secondarythr}{Walk to the steps.  Sit on the green X facing the audience.}

\directionbox{primary}{Move to the yellow star.}

\primary{Mushrooms became a regular part of Cage's music and writing.  We are going to hear two stories from his 1959 work \textit{Indeterminacy}.}
...
\directionbox{secondaryone}{Cross to the plinth and stand in front of the chair.  Here is what is going to happen:  you are going to put on the headphones and then repeat what you hear.  To help people hear your voice, you should look at the top of the stage so your head is raised.  \\
  \\
...
\directionbox{secondaryone}{When the story is over, put the headphones back on the plinth, pick up your binder, and return to where you were standing.}

\primary{Next, story number sixty.}

\directionbox{secondarytwo}{Cross to the plinth and stand in front of the chair.  Here is what is going to happen:  you are going to put on the headphones and then repeat what you hear.  To help people hear your voice, you should look at the top of the stage so your head is raised.  Now it is time to get ready.  Put your binder down on the chair, face up so that you can see these words.  Put on the headphones.   Face the stage.  When you are ready, make a ``thumbs up'' sign with each hand.  You will hear two bongs, then the words for you to repeat.}

\tsdirectionforall{While the Mushroom Verbatim is happening, look at the speaker.}

\tstechnical{Q: SX: Play ``Indeterminacy 60'' audio file over headphones.}

\directionbox{secondarytwo}{When the story is over, put the headphones back on the plinth, pick up your binder, and return to where you were standing, cross to the green tape and go towards the entrance curtains.  Turn onto the blue line and go to the blue square.  Face the piano.}

\directionbox{primary}{When S2 is done and starts to move, walk on the yellow tape and stand on the X.  Face the piano.}

\directionbox{secondaryone}{Follow the pink line to the blue line and stand on the chevrons.  Face the piano.}

\directionbox{secondarythr}{Come down the steps.  Follow the blue line to the X.  Face the piano.}
...
\secondaryone{Cage began teaching mushroom identification at the New School in New York.  This led to him helping to found the New York \pronounce{Mycological}{my-co-LOJ-ical} Society, which is still in operation.  Members would go for walks to find mushrooms to eat, but they also collected them for study.  }

\secondarytwo{Cage was a vice-chairman of what became the North American Mycological Association.}

\secondarythr{He even sometimes sold rare mushrooms to the Four Seasons restaurant in New York.}

\primary{Cage was an \textit{authority} on mushrooms.  Definition again, please.}
...
\secondarytwo{He was recognized by other mushroom lovers and researchers for his knowledge and his association work.  He even won awards.}
...
\tsdirectionforall{Start to move as soon as the musician has played the note.}

\secondaryone{Walk directly towards the stage and sit on the chair (marked with an X) that is to your left (stage right).}

\secondarytwo{Walk directly towards the stage and sit on the chair (marked with an X) that is to your right (stage left).}

\secondarytwo{Walk directly towards the stage and sit on the steps.}

\tsdirectionforall{Tertiaries: Sit on your chair.}

\directionbox{primary}{Stand in front of the plinth (WHERE YOU SHOULD ALREADY BE; CONFIRM).}
...
\directionbox{primary}{This is what will happen: You are going to put on the headphones and follow the instructions you hear about how to conduct this piece.  This is \textit{not} a Mushroom Verbatim.  Do not repeat what you hear.\\
  \\
...
\directionbox{secondaryone}{Go to the pink chevrons, then follow the blue line to the star.  Face the centre.}

\directionbox{secondarytwo}{Follow the blue line to the triangle.}

\directionbox{secondarythr}{Follow the green line to the triangle.  Stop and face the centre.}

\directionbox{primary}{Follow the pink line to the blue line to the podium, and stand behind it.}
...
\directionbox{primary}{Stand on the orange chevrons, facing in.}

\directionbox{secondaryone}{Stand on the orange square, facing in.}

\directionbox{secondarytwo}{Stand on the orange X, facing in.}

\directionbox{secondarythr}{Stand on the orange triangle, facing in.}

\directionbox{musician}{Stand away from the piano, facing the centre.}

\tsdirectionforall{All bow once.}

\tsdirectionforall{Turn half-way around and face out.}

\tsdirectionforall{All bow, then follow the blue line to the exit and leave the Great Hall.}
