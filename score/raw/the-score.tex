...
\tstechnical{Q LX: Pre-show setup.  GM \(\uparrow\) 4. Single-scene mode.  Flash off.  A \(\uparrow\) 10.  B \(\downarrow\) 0.}

\tstechnical{Q SX:  Amp on.  Sound board on.  Master audio level to the mark.  Laptop headphone audio to 3/4.  Plug laptop into 2 TK in the back.  2 TK input level to 5.}

\tstechnical{Q SX: Prepare the thirty-minute introductory background sound with time announcements.}

\tstechnical{Q SX: At 1930, play the thirty-minute introductory background.  It will end at 2000.}
