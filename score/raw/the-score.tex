...
\tstechnical{Q: SX: Play audio file 433-instructions.mp3.  It runs about 5m40s total, with instructions and gaps between movements.}
...
\tstechnical{Q: LX:  A \(\downarrow\) 3 for two seconds, then A \(\uparrow\) 10.}
...
\tstechnical{Q: LX: House lights to full.  Mirror ball motor and light on.}
