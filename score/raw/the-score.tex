...
\speak{p}{There are two last little things about this frame.  It comes with some \textit{knowledge practices}.  Such as:}

\speak{s1}{People who understand this frame will be able to define different types of authority, for example: subject expertise, societal position or personal experience.}
...
\speak{p}{And they know they can develop their own authoritative voices, and this will develop over time, in relation to other authorities.  Also, there are \textit{dispositions}.  People who understand this frame will maintain an open mind.}
...
\speak{s1}{Cage began teaching mushroom identification at the New School in New York.  This led to him helping to found the New York \pronounce{Mycological}{my-co-LOJ-ical} Society, which is still in operation.  Members would go for walks to find mushrooms to eat, but they also collected them for study.  }

\speak{s2}{Cage was a vice-chairman of what became the North American Mycological Association.}

\speak{s3}{He even sometimes sold rare mushrooms to the Four Seasons restaurant in New York.}
...
\speak{s1}{``Yet how to explain the fact that, for hundreds of composers, Cage remains once of the central musical figures of the mid-twentieth century, if not \textit{the} central one? \ldots  For thousands trained in American conservatories, Cage is merely a historical irritant, a charlatan against whom their teachers warned them.''}

\speak{s2}{``For another type, Cage is a model, a basic paradigm for a composer's life.  In America, this is probably the most reliable distinction between what is called the Uptown composer (Uptown as in Manhattan) and the Downtown composer.  Uptown composers mention Cage with anger or contempt or condescension; Downtown composers talk of him with reverence, respect, and seriousness.''}

\speak{s3}{``Perhaps no other composer in history elicits such extremes of approval and disapproval.''}
...
\speak{p}{More discussion here.}

\speak{s1}{A quote from Cage.}

\speak{p}{Something here.}

\speak{s2}{A quote from Cage.}

\speak{p}{Something here.}

\speak{s3}{A quote from Cage.}

\speak{p}{And I will wrap it up, asking the audience to decide for themselves if Cage's approach to music is something worth considering and pursuing.  They can start tonight.}
...
\speak{s1}{Now we will have a performance of \textit{4' 33''}.}

\speak{s2}{The performers will be three of us, and the three of them up on stage, and the musician at the piano.}

\speak{s3}{The conductor will listen to recorded instructions on headphones.  There are three movements, with a brief pause between.}
