...
\technicalbox{q}{LX:  At 1950, turn off the art lights in the Great Hall.  There is a dimmer box in the cupboard under the light control inside the entrance.  Turn off switches 5 and 6.  The small lights facing the art on the walls will go off.}
...
\directionbox{s1}{Cross to the plinth and stand in front of the chair.  Here is what is going to happen:  you are going to put on the headphones and then repeat what you hear.  To help people hear your voice, you should look at the top of the stage so your head is raised.  \\
  \\
  Now it is time to get ready.  Put your binder down on the chair, face up so that you can see these words.  Put on the headphones.   Face the stage.  When you are ready, make a ``thumbs'' up sign with each hand.  You will hear three bongs, then the words for you to repeat.}
...
\directionbox{p}{This is what will happen: You are going to put on the headphones and follow the instructions you hear about how to conduct this piece.  This is \textit{not} a Mushroom Verbatim.  Do not repeat what you hear.\\
  \\
Now it is time to begin.  Stand facing the stage.  Place your score face up on the chair.  Put on the headphones.  When the others in front of you have put their scores on the floor, they are ready.  When you are ready, make a ``thumbs up'' with each hand.  You will hear three bongs, then the instructions.}
...
\speak{s2}{By making this show, Williamson and Denton are presenting themselves as authorities.  Are they?  Ashley Williamson has a PhD in theatre studies.  William Denton is a librarian at York University.  They have some credentials, at least.}

\speak{s3}{This show combines their expertise:  it uses theatrical methods to investigate a concept from library science.  They cited their work.  They gave a bibliography.  The core concept comes from a reputable source.  Their argument seems cogent.}
...
\speak{p}{It's up to you to consider.  Is it true?  It is useful?  Could it be applied in daily life?  Who's to say?}
...
\technicalbox{q}{SX:  Put back the microphone, turn off amp, turn off sound board.}
