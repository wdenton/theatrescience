...
\fbox{\parbox{0.9\textwidth}{A regular box has instructions for other people.  Do not perform these.}}
\vspace{0.5\baselineskip}

% \setlength{\fboxrule}{1pt}

\tstechnical{A dashed box has \textit{technical instructions}, which are also in italics to set them apart. Only Q and R will act on them.}
