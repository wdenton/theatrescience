...
\newcommand{\tsdirectionforall}[1]{\setlength{\fboxrule}{2pt}\vspace{0.1\baselineskip}\fbox{\parbox{0.9\textwidth}{\textbf{#1}}}\setlength{\fboxrule}{1pt}\vspace{0.1\baselineskip}}
...
\newcommand{\directionbox}[2]{
  ...
  \setlength{\fboxrule}{\iftoggle{thick}{2pt}{1pt}}%
...
\newcommand{\tstechnical}[1]{\dbox{\vspace{0.1\baselineskip}\parbox{0.9\textwidth}{\textit{#1}}}\vspace{0.1\baselineskip}}

\newcommand{\playanote}{\directionbox{musician}{When the others have stopped, play a note.}}

\newcommand{\notewait}{\directionbox{primary}{Wait until the note is gone.}}

% \newcommand{\pronounce}[2]{«\dashuline{#2} #1»} % « »
\newcommand{\pronounce}[2]{#1 «~\dashuline{#2}~»} % « »
