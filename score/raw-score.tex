...
\newcommand{\tsdirectionforall}[1]{\setlength{\fboxrule}{5pt}\vspace{0.5\baselineskip}\fbox{\parbox{0.9\textwidth}{\textbf{#1}}}\setlength{\fboxrule}{1pt}\vspace{0.5\baselineskip}}
...
\direction{Pause 1} means pause for a count of one, which you might time by saying to yourself, ``One one thousand.''.  \direction{Pause 2} means pause for a count of two, which you might time by saying to yourself, ``One one thousand, two one thousand.''  \direction{Pause 5}, you can see, would be a long pause where you count up to 5.  Don't rush a pause.  The audience will wait for you.
...
\tsdirectionforall{Everyone else copy Primary's arm movements as best you can.}
...
\secondaryone{John Milton Cage Jr. was an American composer.  He was born in Los Angeles in 1912 and died in New York in 1992.  He studied briefly under composer Arnold Schoenberg [SHERN-berg].  In the early 1940s, he moved to New York, where he met Marcel Duchamp [mar-SELL doo-SHOMP] and other artists.}
...
\secondarythr{Cage married in his early twenties, but divorced his wife in 1945 and spent the rest of his life with Merce [MURSE] Cunningham, a dancer and choreographer.}

\directionbox{secondarythr}{Turn one-quarter to the left.}

\secondaryone{He used chance in his work.  These are ``aleatory'' [AYE-lee-uh-tory] compositions.  He would often roll dice to determine what would happen next.  He used the \textit{I Ching} [EE CHING] as a compositional tool.  He also used silence.}
...
\secondarythr{He was a Zen Buddhist.  He laughed a lot.  He organized the first Happenings.  He was a mushroom expert: a mycologist [my-COLL-o-jist].  He composed music for Merce's dances.}
...
\secondarytwo{I will mention the books he wrote, and all the books and documentaries about him.}

\secondarythr{I will mention awards, CDs, the John Cage Trust.  General impact now.}

\primary{You may never have heard anything composed by John Cage.  You will probably never hear his music without making an effort to go find it.  Other twentieth-century composers, like Duke Ellington, Dmitri Shostakovich or Benjamin Britten, are much more likely to turn up on the radio or at a performance.  Even so, there's no denying he was a major figure in twentieth century music.  Now that we have a sense of that, we move on to mushrooms.}
...
\subsection{Scenario 6: Cage and authority (5 min)}
...
\primary{That's authority.  It's constructed, it's contextual, but he's an authority on mushrooms.  But what about music?  The construction and context of the authority there is very different.}
...
\secondaryone{A remark.}

\secondarytwo{A remark.}

\secondarythr{A remark.}
