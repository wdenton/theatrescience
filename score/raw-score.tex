...
\tertiaryone{``The use of information in creating new knowledge.''  When we want to find something out, when we have a gap in our knowledge, it's often because we want to make something new of our own. }

\tertiarytwo{``Participating ethically in communities of learning.''  The ethics involve attribution and citation, understanding copyrights and licenses, knowing about plagiarism, and so on.}

\tertiarythr{And a community of learning could be a class in a school, a college, a university, a continuing education program, but it could be people anywhere: a neighbourhood group, some people here at the Club, or you and your family.}
...
\tstechnical{R: Show ``Information resources reflect'' paragraph with first line bold.}
...
\secondarytwo{Or if I had to write something about the Winnipeg general strike in 1870.  If I just need to make up a couple of paragraphs, the Wikipedia entry is enough.  But if I'm studying Canadian labour history at university, I'd need to read books by historians and labour experts.}

\primary{Experts.  Let's remember that word.  We've got authority and we've got expertise.  But ...}

\tstechnical{R: Show ``Information resources reflect'' paragraph with second line bold.}

\primary{Authority isn't absolute.  Different people can recognize different types of authority in different situations.}

\secondarythr{For the Winnipeg strike, a historian who understands the entire Canadian political situation of that time could be an authority, if she's written about it, and is consulted by others, and asked onto \textit{The Agenda} to compare what happened then to inequality now. But someone who was actually in the strike, and left a detailed diary, would also be an authority.}

\primary{We'll skip the last line for now.}
