...
\primary{So in 2016 a group wrote \textit{Framework for Information Literacy for Higher Education}.  It has six ``frames.''  These frames are ``threshold concepts.''  That's when you go from just having a set of facts or rules to getting the big picture of how it all fits together.  When you hit that point, you have a deeper understanding of the subject, and not only that, you know the nuances and you realize things are more complicated than they used to seem.  The six frames are these.}
...
\secondaryone{He used chance into his work.  These are ``aleatory'' [AYE-lee-uh-tory] compositions.  He would often roll dice to determine what would happen next.  He became a Zen Buddhist.  He used the \textit{I Ching} [EE CHING] as a compositional tool.  [FACE THE CENTRE.]}
...
\primary{It has three movements.  Each is the word ``Tacet'' [TASS-it].  This tells the musician not to play.  It was first performed by pianist David Tudor in 1952, in a concert hall that had been converted from an old barn in the woods.  He came out on stage and sat at the piano.}
...
\secondaryone{A book.  A web site.  A documentary.  A Facebook post.  An article in an academic journal.  A thread on Twitter.  A newspaper report.  A pamphlet your doctor gave you.  Could be a person!  Like your cousin who knows about really good foreign-language TV shows.}
...
\primary{Now we go back to our example:  John Cage.}
...
\primary{Now: mushrooms.  Mushroom fact number one.  Mushrooms are not plants, they are \textit{fungi}.  }

\secondaryone{So are yeast and mould.  In biology, plants are a kingdom, animals are a kingdom, and fungi are a kingdom.  They don't use photosynthesis.  They get their energy by eating things like wood.}
...
\primary{Most importantly, mushroom fact number zero.  If you don't know that a mushroom is edible, don't eat it!  Mushrooms in the grocery store:  safe.  Mushrooms in the forest:  unknown!  Before eating, talk to someone who knows.  Consult an \textit{authority}.}
...
Stories from \textit{Indeterminacy}: 48 and 60.  Use 143?  There are 90, each one minute long.
