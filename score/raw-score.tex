...
\primary{Now: mushrooms.  Quick mushroom facts.  Mushroom fact number one.  Mushrooms are not plants, they are \textit{fungi}.  }

\secondaryone{They don't use photosynthesis.  They get their energy by eating things like wood.}

\primary{Mushroom fact number two.  A mushroom is the fruiting body of a fungus.}

\secondarytwo{It will release spores.  They don't have seeds.}

\primary{Mushroom fact number three.  There is an awful lot going on underground you can't see.}

\secondarythr{Mushrooms grow out of a complex structure in the ground called a \textit{mycelium} [my-SEE-lee-um].  It looks like a lot of thin white threads.}
...
Explain about the Mushroom Verbatims.

\secondaryone{[WALK TO THE PLINTH IN THE CENTRE.  PUT YOUR SCORE ON THE CHAIR, THEN PUT ON THE HEADPHONES.  FACE THE VIKING SHIP ABOVE THE STAGE.  LOOK AT IT.  REPEAT WHAT YOU HEAR.]}

\tsdirectionforall{While the Mushroom Verbatim is happening, look at the speaker.}

Something.

\secondarytwo{[WALK TO THE PLINTH IN THE CENTRE.  PUT YOUR SCORE ON THE CHAIR, THEN PUT ON THE HEADPHONES.  FACE THE VIKING SHIP ABOVE THE STAGE.  LOOK AT IT.  REPEAT WHAT YOU HEAR.]}
